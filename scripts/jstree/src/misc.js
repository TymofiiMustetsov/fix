...
(function (factory) {
	...
	if (typeof define === 'function' && define.amd) {
		define('jstree.node_customize', ['jquery','src/assets/scripts/jstree/src/jstree'], factory);
	}
	else if(typeof exports === 'object') {
		factory(require('jquery'), require('src/assets/scripts/jstree/src/jstree'));
	}
	else {
...
(function (factory) {
        "use strict";
        if (typeof define === 'function' && define.amd) {
                define('jstree.parentsload', ['jquery','src/assets/scripts/jstree/src/jstree'], factory);
        }
        else if(typeof exports === 'object') {
                factory(require('jquery'), require('src/assets/scripts/jstree/src/jstree'));
        }
...
(function (factory) {
	"use strict";
	if (typeof define === 'function' && define.amd) {
		define('jstree.conditionaldeselect', ['jquery','src/assets/scripts/jstree/src/jstree'], factory);
	}
	else if(typeof exports === 'object') {
		factory(require('jquery'), require('src/assets/scripts/jstree/src/jstree'));
	}
...
(function (factory) {
	"use strict";
	if (typeof define === 'function' && define.amd) {
		define('jstree.conditionalclose', ['jquery','src/assets/scripts/jstree/src/jstree'], factory);
	}
	else if(typeof exports === 'object') {
		factory(require('jquery'), require('src/assets/scripts/jstree/src/jstree'));
	}
